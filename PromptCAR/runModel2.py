...
from BertPromptSS import BertPromptSS
...
args.save_path += BertPromptSS.__name__ + "." +  args.task
args.log_path += BertPromptSS.__name__ + "." + args.task + ".log"
args.score_file_path += BertPromptSS.__name__ + "." + args.task + ".score.txt"
