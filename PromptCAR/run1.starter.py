...
def main():
    ...
    os.system(f"cd /cache/code/ && python runModel.py --data_path /cache/data/data/ --score_file_path /cache/output/ --bert_model_path /cache/pretrained_model/BertLarge/ --per_gpu_batch_size 64  --per_gpu_test_batch_size 64 --log_path /cache/output/logs/ --save_path /cache/output/models/BertPromptSS --epochs 6 --learning_rate 5e-5")
