...
def retrieval_test():
    d = 768
    query_vec = np.asarray(torch.load("./output/result/reddit3/test.10w.bart.ctx.onlyret.pt"))
    doc_vec = np.asarray(torch.load("./output/result/reddit3/test.10w.bart.rep.onlyret.pt"))
