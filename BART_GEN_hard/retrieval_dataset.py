...
# dataset for BARTRetOnlyModel2, hard negative + in batch negative
...
class FileDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        context_input_ids = context_encode.input_ids
        context_attention_mask = context_encode.attention_mask
        context_eos_position = context_input_ids.index(self._tokenizer.eos_token_id)
        ...
        batch = {
            "context_input_ids": np.asarray(context_input_ids),
